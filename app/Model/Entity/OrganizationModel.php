...
class OrganizationModel {
    ...
    //organization site
    //@var [type]
    public $site = 'https://www.youtube.com/watch?v=TmeyoTNu748';

    //organization description
    //@var String
    public $description = 'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, 
